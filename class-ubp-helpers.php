...
class UBP_Helpers {
	...
	public static function require_no_multisite() {
		...
		if ( is_admin() && ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) ) {
			...
			wp_die( esc_html__( 'Uploads by Proxy is not yet compatible with network installs. The plugin has now disabled itself. Please activate on single-site installs only.', 'uploads-by-proxy' ) );
		}
